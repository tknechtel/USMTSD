...
synthetic_data2 = np.genfromtxt(datapath + "syn_1400_12_14.csv", skip_header=0, delimiter=',')
...
if __name__ == '__main__':
    ...
    #X = synthetic_data2
    WS2 = pd.read_excel('/content/drive/MyDrive/Masterarbeit/Thesis/Data/Datafinal/syn2_vma.xlsx')


    WS2["mean1"]= WS2["Column1"].rolling(10).mean()
    WS2["mean2"]= WS2["Column2"].rolling(10).mean()
    WS2["mean3"]= WS2["Column3"].rolling(10).mean()
    WS2["mean4"]= WS2["Column4"].rolling(10).mean()
    WS2["mean5"]= WS2["Column5"].rolling(10).mean()
    WS2["mean6"]= WS2["Column6"].rolling(10).mean()
    WS2["mean7"]= WS2["Column7"].rolling(10).mean()
    WS2["mean8"]= WS2["Column8"].rolling(10).mean()
    WS2["mean9"]= WS2["Column9"].rolling(10).mean()
    WS2["mean10"]= WS2["Column10"].rolling(10).mean()
    WS2["mean11"]= WS2["Column11"].rolling(10).mean()
    WS2["mean12"]= WS2["Column12"].rolling(10).mean()
