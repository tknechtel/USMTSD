...
synthetic_data_1_v2 = np.genfromtxt("/content/drive/MyDrive/Masterarbeit/Thesis/Data/Datafinal/syn1_v2.csv", delimiter=',',skip_header=1)
...
if __name__ == '__main__':
    #WS = pd.read_excel('/content/drive/MyDrive/Masterarbeit/Thesis/Data/Datafinal/syn1_moving_agerage1.xlsx')
    #WS_np = np.array(WS)

    WS2 = pd.read_excel('/content/drive/MyDrive/Masterarbeit/Thesis/Data/Datafinal/syn1_vma.xlsx')
